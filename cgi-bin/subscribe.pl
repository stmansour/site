...
#
#  This script will attempt to add the email address to $target
#
#  Steve Mansour
...
print "<html><head><title>Email List Response</title><meta http-equiv=\"refresh\" content=\"0; url=/music/elist/$htmlpage\"/></head><body>transferring...</body></html>"
